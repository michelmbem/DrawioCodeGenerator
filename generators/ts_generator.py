...
class TsCodeGenerator(CodeGeneratorInterface):
    ...
    def generate_properties(self, properties):
        ...
        for _, _property_value in properties.items():
            p = f"\t{_property_value['access']} {_property_value['name']} : {_property_value['type']};\n"
    ...
    def generate_methods(self, methods, properties, class_type, interface_methods):
        ...
        for _, method_value in methods.items():
            m = f"\t{method_value['access']} {method_value['name']}() : {method_value['return_type']} {{}}\n";
            methods_string += m + "\n"
